...
export default function Addfound() {
  ...
  const handleSubmit = async () => {
    ...
    if (form.contactPhone.length < 9) {
      Alert.alert(
        'Invalid Phone Number',
        'The minimal length for a phone number is 9 characters.'
      );
      return;
    }
  ...
  <Text className="text-3xl font-bold text-black-100">Add Found Animal</Text>
</View>
          <View className="mt-7 space-y-2">
            ...
            <TouchableOpacity
              ...
              className="w-full h-16 px-4 bg-white rounded-lg border border-gray-300 flex justify-center items-center shadow"
            >
          ...
          <View className="mt-7">
              <ReCaptcha
                ref={recaptcha}
                siteKey="6LcDqHsqAAAAAIg7SMoe4YhLT2_hIfDubkdRkD3V" // safe to public
